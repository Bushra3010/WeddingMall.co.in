  ...
  return (
    ...
    >
      <div className="mx-auto flex h-18 max-w-[90rem] items-center gap-6 px-4 sm:px-6 lg:px-10">
        ...
        >
          {/*
            The artwork carries the wordmark, so no text sits beside it. Over
            the hero the header is transparent and the backdrop is near-black
            maroon, where the logo's own maroon strokes disappear —
            `brightness-0 invert` paints it flat white for that state.
          */}
          <Image
